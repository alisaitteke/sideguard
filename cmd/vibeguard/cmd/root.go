// Package cmd defines the VibeGuard cobra CLI surface.
package cmd
...
var rootCmd = &cobra.Command{
	...
	Long:  "VibeGuard intercepts shell commands and MCP tool calls, holding them for user approval.",
...
var daemonCmd = &cobra.Command{
	Use:   "daemon",
	Short: "Manage the VibeGuard background daemon",
}
