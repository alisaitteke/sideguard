...
See docs/plans/2026-07-01-0127-sideguard-foundation/ (vgf-phase-7.0-policy-engine.md).`,
}
...
var policyValidateCmd = &cobra.Command{
	...
	RunE: func(_ *cobra.Command, _ []string) error {
		...
		workspacePath := fmt.Sprintf("%s/.sideguard/policy.yaml", cwd)
...
var policyInitDevCmd = &cobra.Command{
	...
	Long: `Creates .sideguard/policy.yaml in the current repo with allow rules for make, go, and scripts/
only when the shell cwd is under this repo root. Safe for developing SideGuard inside Cursor
