// Package tui implements the interactive terminal approval UI (vibeguard ui).
// Addresses post-MVP Tier 2/3 from docs/integration-and-terminal-ui.md.
package tui
...
// FormatAgeShort returns a compact age like "5s" for the interactive UI list.
